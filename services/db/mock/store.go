...
// Source: github.com/minhtri67/simplebank/db/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/minhtri67/simplebank/db/sqlc"
)
...
func (m *MockStore) ListEntrys(arg0 context.Context, arg1 sqlc.ListEntrysParams) ([]sqlc.Entry, error) {
	m.ctrl.T.Helper()
